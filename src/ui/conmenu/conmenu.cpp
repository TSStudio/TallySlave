...
UI_GenericMenu setup_ui_conmenu_screen(unsigned int& screen_handle) {
    ...
    UI_GenericMenu_Selection* selections = GM_make_selections(4, GM_make_selection(selection1), GM_make_selection(selection2, false, 12), GM_make_selection(selection3, false, 13), GM_make_selection(selection4, false, 14));
