...
void refresh_screen() {
    if (current_screen != screen) {
        ...
        if (screens.find(screen) == screens.end()) {
            Serial.println("No screen found, trying to build");
            screen_builders[screen]();
            if (screens.find(screen) == screens.end()) {
                Serial.println("Still no screen found, going back");
...
void init_builders() {
    ...
    screen_builders[1] = [] {
        ...
        static UI_GenericMenu_Selection* selections = GM_make_selections(4, GM_make_selection(selection1, false, 11), GM_make_selection(selection2, false, 12), GM_make_selection(selection3, false, 13), GM_make_selection(selection4, false, 14));
        UI_GenericMenu* menu = new UI_GenericMenu(title, 0, screen, selections, 4, 1);
        screen_co screen_common;
    ...
    screen_builders[11] = [] {
        ...
        static UI_GenericMenu_Selection* selections = GM_make_selections(3, GM_make_selection(selection1, false, 0, callback1), GM_make_selection(selection2, false, 0, callback2), GM_make_selection(selection3, false, 0, callback3));
        unsigned char interface_type = config.interface_type;
        selections[interface_type].isUsing = true;
        UI_GenericMenu* menu = new UI_GenericMenu(title, 1, screen, selections, 3, 11);
        screen_co screen_common;
        screen_common.screen_obj = menu->scr;
        screen_common.refresh_handle_t0 = ui_generic_menu_handle_update;
        screen_common.type = 0;
    ...
    screen_builders[12] = [] {
        ...
        static UI_GenericMenu_Selection* selections = GM_make_selections(4, GM_make_selection(selection1, false, 121), GM_make_selection(selection2, false, 122), GM_make_selection(selection3, false, 123), GM_make_selection(selection4, false, 124));
        UI_GenericMenu* menu = new UI_GenericMenu(title, 1, screen, selections, 4, 12);
    ...
    screen_builders[1212] = [] {
        ...
        UI_GenericInput* input = new UI_GenericInput(
            ...
            15, config.wifiPassword, false, 1212);
        screen_co screen_common;
        screen_common.screen_obj = input->scr;
        screen_common.refresh_handle_t2 = ui_generic_input_handle_update;
        screen_common.type = 2;
    ...
    screen_builders[122] = [] {
        ...
        static UI_GenericMenu_Selection* selections = GM_make_selections(2, GM_make_selection(selection1, false, 1221), GM_make_selection(selection2, false, 1222));
        UI_GenericMenu* menu = new UI_GenericMenu(title, 12, screen, selections, 2, 122);
